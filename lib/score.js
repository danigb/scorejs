...
function Score(source, data) {
  ...
  Score.emitter.emit('created', this);
}
...
Score.emitter = new EventEmitter();
Score.on = function(name, callback) { Score.emitter.on(name, callback); }
